...
//FIX ME: esto se queda pegado en el primer programa que se reproduce cuando carga por primera vaz
                    videoPlayer.addEventListener('ended', function() {
                        console.log('AAAAAAAAAAAAAAAAA',currentProgram)
    ...
    function onVideoEnded(currentProgram) {
        ...
        function loadPostRoll(recurso) {
            ...
            if (recurso.publicity !== 0) {
                ...
                videoPlayer.addEventListener('ended', function() {
                    console.log('BBBBBBBBBBBBBBBB',currentChannel)
                    loadContent(currentChannel);
                });
            } else {
